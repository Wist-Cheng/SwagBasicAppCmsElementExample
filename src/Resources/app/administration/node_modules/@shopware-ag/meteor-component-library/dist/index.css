...
.mt-field-label[data-v-a07c6eb0] {
  display: flex;
...
.mt-field-label--is-required[data-v-a07c6eb0]::after {
  content: "*";
  color: var(--color-text-brand-default);
}
.mt-field-label--has-linked-inheritance[data-v-a07c6eb0] {
  color: var(--color-text-accent-default);
}
.mt-field-label--with-error[data-v-a07c6eb0] {
...
.mt-text--weight-bold[data-v-c49060dc] {
  font-weight: var(--font-weight-bold);
}
.mt-text--weight-semibold[data-v-c49060dc] {
  font-weight: var(--font-weight-semibold);
}
.mt-text--weight-medium[data-v-c49060dc] {
  font-weight: var(--font-weight-medium);
}
.mt-text--weight-regular[data-v-c49060dc] {
  font-weight: var(--font-weight-regular);
}
.mt-text--size-2xs[data-v-c49060dc] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-2xs);
  line-height: var(--font-line-height-2xs);
}
.mt-text--size-xs[data-v-c49060dc] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
}
.mt-text--size-s[data-v-c49060dc] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-s);
  line-height: var(--font-line-height-s);
}
.mt-text--size-m[data-v-c49060dc] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-m);
  line-height: var(--font-line-height-m);
}
.mt-text--size-l[data-v-c49060dc] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-l);
  line-height: var(--font-line-height-l);
}
.mt-text--size-xl[data-v-c49060dc] {
  font-family: var(--font-family-headings);
  font-size: var(--font-size-xl);
  line-height: var(--font-line-height-xl);
}
.mt-text--size-2xl[data-v-c49060dc] {
  font-family: var(--font-family-headings);
  font-size: var(--font-size-2xl);
  line-height: var(--font-line-height-2xl);
}
.mt-text--size-3xl[data-v-c49060dc] {
  font-family: var(--font-family-headings);
...
.mt-banner--future-remove-default-margin[data-v-be5fc1d5] {
  margin-block-end: 0;
}
.mt-banner__title[data-v-be5fc1d5] {
  margin-block-end: 0;
}
.mt-banner__body[data-v-be5fc1d5] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  display: flex;
...
.mt-banner__icon[data-v-be5fc1d5] {
...
&[data-v-be5fc1d5] :is(.mt-banner__icon, .mt-banner__close) {
...
&[data-v-66748148] {
    ...
    animation: mt-loader-rotator-66748148 1.4s cubic-bezier(0.5, 0, 0.5, 1) infinite;
    }
&[data-v-66748148]:nth-child(1) {
      animation-delay: -0.45s;
}
&[data-v-66748148]:nth-child(2) {
      animation-delay: -0.3s;
}
&[data-v-66748148]:nth-child(3) {
      animation-delay: -0.15s;
}
}
}
.mt-loader__container[data-v-66748148] {
  display: grid;
...
@keyframes mt-loader-rotator-66748148 {
0% {
...
.mt-field__error[data-v-c1a10ffb] {
  display: flex;
  align-items: center;
  gap: var(--scale-size-4);
...
.mt-progress-bar[data-v-45364215] {
  display: grid;
  grid-template-areas:
    "label progress"
    "track track"
...
.mt-progress-bar__progress-label[data-v-45364215] {
  color: var(--color-text-secondary);
  grid-area: progress;
  justify-self: end;
}
.mt-progress-bar__track[data-v-45364215] {
...
.mt-progress-bar__fill[data-v-45364215] {
  border-radius: var(--border-radius-round);
  height: 100%;
  background: var(--color-interaction-primary-default);
}
.mt-progress-bar__fill--with-error[data-v-45364215] {
  background: var(--color-interaction-critical-default);
}

.mt-button[data-v-f5525652] {
...
.mt-button__content[data-v-f5525652] {
  display: grid;
  grid-auto-flow: column;
  align-items: center;
  column-gap: var(--scale-size-8);
}
.mt-button__content--hidden[data-v-f5525652] {
  visibility: hidden;
}
.mt-button--primary[data-v-f5525652] {
  background: var(--color-interaction-primary-default);
  color: var(--color-text-static-default);
  border-color: var(--color-interaction-primary-default);
}
.mt-button--primary .mt-icon[data-v-f5525652] {
  color: var(--color-icon-static-default);
}
.mt-button--primary[data-v-f5525652]:hover,
.mt-button--primary[data-v-f5525652]:focus-visible,
.mt-button--primary[data-v-f5525652]:active {
...
.mt-button--primary[data-v-f5525652]:disabled,
.mt-button--primary.mt-button--disabled[data-v-f5525652] {
  background: var(--color-interaction-primary-disabled);
  border-color: var(--color-interaction-primary-disabled);
  cursor: not-allowed;
}
.mt-button--primary-ghost[data-v-f5525652] {
  background: transparent;
  border: 1px solid var(--color-border-brand-selected);
  border-color: var(--color-border-brand-selected);
  color: var(--color-text-brand-default);
}
.mt-button--primary-ghost[data-v-f5525652]:is(:hover, :focus-visible, :active) {
  background: var(--color-background-brand-default);
}
.mt-button--primary-ghost[data-v-f5525652]:focus-visible {
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--primary-ghost[data-v-f5525652]:disabled,
.mt-button--primary-ghost.mt-button--disabled[data-v-f5525652] {
  color: var(--color-text-brand-disabled);
  border-color: var(--color-border-brand-disabled);
  background: transparent;
}
.mt-button--primary-ghost:disabled .mt-icon[data-v-f5525652],
.mt-button--primary-ghost.mt-button--disabled .mt-icon[data-v-f5525652] {
  color: var(--color-icon-brand-disabled);
}
.mt-button--primary-ghost .mt-icon[data-v-f5525652] {
  color: var(--color-icon-brand-default);
}
.mt-button--secondary[data-v-f5525652] {
  background: var(--color-interaction-secondary-default);
  border: 1px solid var(--color-border-primary-default);
  color: var(--color-text-primary-default);
}
.mt-button--secondary[data-v-f5525652]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-secondary-hover);
}
.mt-button--secondary[data-v-f5525652]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--secondary[data-v-f5525652]:disabled,
.mt-button--secondary.mt-button--disabled[data-v-f5525652] {
  color: var(--color-text-primary-disabled);
  background: var(--color-interaction-secondary-disabled);
  cursor: not-allowed;
}
.mt-button--secondary:disabled .mt-icon[data-v-f5525652],
.mt-button--secondary.mt-button--disabled .mt-icon[data-v-f5525652] {
  color: var(--color-icon-primary-disabled);
}
.mt-button--secondary .mt-icon[data-v-f5525652] {
  color: var(--color-icon-primary-default);
}
.mt-button--critical[data-v-f5525652] {
  background: var(--color-interaction-critical-default);
  color: var(--color-text-static-default);
  border: 1px solid var(--color-interaction-critical-default);
}
.mt-button--critical[data-v-f5525652]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-critical-hover);
  border-color: var(--color-interaction-critical-hover);
}
.mt-button--critical[data-v-f5525652]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--critical[data-v-f5525652]:disabled,
.mt-button--critical.mt-button--disabled[data-v-f5525652] {
  background: var(--color-interaction-critical-disabled);
  border-color: var(--color-interaction-critical-disabled);
}
.mt-button--critical:disabled .mt-icon[data-v-f5525652],
.mt-button--critical.mt-button--disabled .mt-icon[data-v-f5525652],
.mt-button--critical .mt-icon[data-v-f5525652] {
  color: var(--color-icon-static-default);
}
.mt-button--critical-ghost[data-v-f5525652] {
  background: transparent;
  border: 1px solid var(--color-border-critical-default);
  color: var(--color-text-critical-default);
}
.mt-button--critical-ghost[data-v-f5525652]:is(:hover, :focus-visible, :active) {
  background-color: var(--color-background-critical-dark);
}
.mt-button--critical-ghost[data-v-f5525652]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(255, 0, 0, 0.3);
}
.mt-button--critical-ghost[data-v-f5525652]:disabled,
.mt-button--critical-ghost.mt-button--disabled[data-v-f5525652] {
  color: var(--color-text-critical-disabled);
  border-color: var(--color-border-critical-disabled);
}
.mt-button--critical-ghost:disabled .mt-icon[data-v-f5525652],
.mt-button--critical-ghost.mt-button--disabled .mt-icon[data-v-f5525652] {
  color: var(--color-icon-critical-disabled);
}
.mt-button--critical-ghost .mt-icon[data-v-f5525652] {
  color: var(--color-icon-critical-default);
}
.mt-button--action[data-v-f5525652] {
  border: 1px solid #e2e8f0;
  background-color: #ffffff;
  color: #000000;
}
.mt-button--action .mt-icon[data-v-f5525652] {
  color: #1a202c;
}
.mt-button--action[data-v-f5525652]:hover {
  background-color: #edf2f7;
  color: #4a5568;
}
.mt-button--action[data-v-f5525652]:disabled {
  background-color: #f7fafc;
  color: #a0aec0;
}
.mt-button--block[data-v-f5525652] {
  display: block;
  width: 100%;
  display: flex;
  justify-content: center;
...
.mt-button--x-small[data-v-f5525652] {
  padding-left: var(--scale-size-10);
  padding-right: var(--scale-size-10);
  font-size: var(--font-size-2xs);
  min-height: 24px;
}
.mt-button--x-small.mt-button--square[data-v-f5525652] {
  width: var(--scale-size-24);
  height: var(--scale-size-24);
}
.mt-button--small[data-v-f5525652] {
  padding-left: 15px;
  padding-right: 15px;
  font-size: var(--font-size-2xs);
  min-height: 32px;
}
.mt-button--small.mt-button--square[data-v-f5525652] {
  width: var(--scale-size-32);
  height: var(--scale-size-32);
}
.mt-button--default[data-v-f5525652] {
  padding-inline: var(--scale-size-16);
  font-size: var(--font-size-xs);
  min-height: 2.5rem;
}
.mt-button--default.mt-button-square[data-v-f5525652] {
  width: var(--scale-size-40);
  height: var(--scale-size-40);
}
.mt-button--large[data-v-f5525652] {
  padding-left: var(--scale-size-28);
  padding-right: var(--scale-size-28);
  min-height: 3rem;
  font-size: var(--font-size-2xs);
}
.mt-button--large.mt-button--square[data-v-f5525652] {
  width: var(--scale-size-48);
  height: var(--scale-size-48);
}
.mt-button--square[data-v-f5525652] {
  width: var(--scale-size-40);
  height: var(--scale-size-40);
  padding-left: 0;
  padding-right: 0;
...
.mt-button--square .mt-button__content[data-v-f5525652] {
  display: inline;
}
.mt-button__loader[data-v-f5525652] {
  border-radius: var(--border-radius-xs);
}

.mt-inheritance-switch[data-v-c8e17518] {
  cursor: pointer;
  margin-top: -1px;
}
.mt-inheritance-switch--disabled[data-v-c8e17518] {
  cursor: default;
}

.mt-field-copyable[data-v-7dfb9052] {
  cursor: pointer;
}

.tooltip[data-v-33064978] {
...
.v-enter-active[data-v-33064978],
.v-leave-active[data-v-33064978] {
...
.v-enter-from[data-v-33064978],
.v-leave-to[data-v-33064978] {
  opacity: 0;
}
.v-enter-from[data-placement="top"][data-v-33064978],
.v-leave-to[data-placement="top"][data-v-33064978] {
  margin-bottom: var(--scale-size-5);
}
.v-enter-from[data-placement="bottom"][data-v-33064978],
.v-leave-to[data-placement="bottom"][data-v-33064978] {
  margin-top: var(--scale-size-5);
}
.v-enter-from[data-placement="left"][data-v-33064978],
.v-leave-to[data-placement="left"][data-v-33064978] {
  margin-right: var(--scale-size-5);
}
.v-enter-from[data-placement="right"][data-v-33064978],
.v-leave-to[data-placement="right"][data-v-33064978] {
...
&[data-v-bfb2b685]:focus-visible {
    outline-offset: 0.25rem;
    outline: 2px solid var(--color-border-brand-selected);
}
&[data-v-bfb2b685]:where(:hover, :focus-visible) {
    color: var(--color-icon-brand-hover);
}
}
.mt-help-text[data-v-bfb2b685]::after {
  content: "";
  display: block;
  position: absolute;
  inset: 0;
...
.mt-help-text__tooltip-text[data-v-bfb2b685] {
  display: none;
}
/* ------------------------------------
 * Administration variables
...
.mt-field__hint:empty, .mt-field__hint-right:empty {
  display: none;
}
...
.mt-field input:invalid, .mt-field input:-moz-submit-invalid, .mt-field input:-moz-ui-invalid,
...
.mt-colorpicker__colorpicker-selection {
  ...
  border: 1px solid var(--color-border-primary-default);
  border-radius: var(--border-radius-xs);
  background-image: linear-gradient(180deg, #fff, rgba(255, 255, 255, 0) 50%), linear-gradient(0deg, #000, rgba(0, 0, 0, 0) 50%), linear-gradient(90deg, #808080, rgba(128, 128, 128, 0) 100%);
}
...
.mt-field-affix[data-v-6832faed] {
  display: grid;
  place-items: center;
...
.mt-email-field--future-no-default-margin[data-v-be59bb11] {
  margin-bottom: 0;
}
...
&[data-v-be59bb11] ::placeholder {
    color: var(--color-text-secondary-default);
}
&:not(.mt-email-field__block--error)&[data-v-be59bb11]:has(.mt-email-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0px 0px 4px 0px rgba(24, 158, 255, 0.3);
}
...
.mt-email-field__block--error[data-v-be59bb11] {
  border-color: var(--color-border-critical-default);
  background-color: var(--color-background-critical-dark);
}
.mt-email-field__input[data-v-be59bb11] {
  -webkit-appearance: none;
  -moz-appearance: none;
  appearance: none;
...
&[data-v-be59bb11]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-be59bb11]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
}
}
.mt-email-field__hint[data-v-be59bb11] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  color: var(--color-text-tertiary-default);
...
.mt-email-field__block--small[data-v-be59bb11] {
...
&[data-v-a780dde2]:focus-visible {
    outline-offset: 2px;
    outline: 2px solid var(--color-border-brand-selected);
    border-radius: var(--border-radius-xs);
}
}
.mt-link[data-v-a780dde2]:is(:disabled, .mt-link--disabled) {
  cursor: not-allowed;
}
.mt-link--primary[data-v-a780dde2] {
  color: var(--color-text-brand-default);
}
.mt-link--primary[data-v-a780dde2]:is(:hover, :active) {
  color: var(--color-text-brand-hover);
}
.mt-link--primary[data-v-a780dde2]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-brand-disabled);
}
.mt-link--critical[data-v-a780dde2] {
  color: var(--color-text-critical-default);
}
.mt-link--critical[data-v-a780dde2]:is(:hover, :active) {
  color: var(--color-text-critical-hover);
}
.mt-link--critical[data-v-a780dde2]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-critical-disabled);
}
...
&[data-v-991875f5]:is(:hover, :focus-visible) {
      background-color: var(--color-interaction-secondary-hover);
}
&[data-v-991875f5]:disabled {
      cursor: default;
}
}
}
input.mt-number-field__align-end[data-v-991875f5] {
  text-align: end;
}
...
.mt-password-field[data-v-f7fa0652] {
  width: 100%;
}
...
&:not(.mt-password-field__block--error)&[data-v-f7fa0652]:has(.mt-password-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0px 0px 4px 0px rgba(24, 158, 255, 0.3);
}
&[data-v-f7fa0652]:has(input:disabled) {
    background-color: var(--color-background-primary-disabled);
}
}
.mt-password-field__block--error[data-v-f7fa0652] {
  border-color: var(--color-border-critical-default);
...
&[data-v-f7fa0652]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-f7fa0652]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
}
}
...
.mt-select:hover .mt-select__select-indicator-clear, .mt-select.has--focus .mt-select__select-indicator-clear {
  opacity: 1;
  pointer-events: all;
  cursor: pointer;
}
...
.mt-popover-deprecated .mt-popover-deprecated__wrapper {
  position: inherit;
}
.mt-popover-deprecated__wrapper.--placement-bottom-outside {
...
.mt-color-badge.is--critical, .mt-color-badge.is--danger {
...
.mt-color-badge.has--text.is--critical, .mt-color-badge.has--text.is--danger {
...
.mt-label.mt-label--info.mt-label--small, .mt-label.mt-label--danger.mt-label--small, .mt-label.mt-label--success.mt-label--small, .mt-label.mt-label--warning.mt-label--small, .mt-label.mt-label--neutral.mt-label--small {
  font-weight: 600;
  line-height: 14px;
  font-size: 12px;
  padding: 0 5px;
...
.mt-label.mt-label--info.mt-label--small::before, .mt-label.mt-label--danger.mt-label--small::before, .mt-label.mt-label--success.mt-label--small::before, .mt-label.mt-label--warning.mt-label--small::before, .mt-label.mt-label--neutral.mt-label--small::before {
  content: "";
  display: block;
...
.mt-label.mt-label--info:not(.mt-label--appearance-badged) {
  background-color: #e3f3ff;
  border-color: #bae2ff;
  color: #189eff;
}
.mt-label.mt-label--info:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #189eff;
}
.mt-label.mt-label--info:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #189eff;
}
.mt-label.mt-label--info:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #189eff;
}
.mt-label.mt-label--info:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #189eff;
}
.mt-label.mt-label--info:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #189eff;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged) {
  background-color: #e7f9e9;
  border-color: #c3f1c8;
  color: #37d046;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #37d046;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #37d046;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #37d046;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #37d046;
}
.mt-label.mt-label--success:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #37d046;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged) {
  background-color: #fbe5ea;
  border-color: #f5bfc9;
  color: #de294c;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #de294c;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #de294c;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #de294c;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #de294c;
}
.mt-label.mt-label--danger:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #de294c;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged) {
  background-color: #fff3e0;
  border-color: #ffe0b2;
  color: #ff9800;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #ff9800;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #ff9800;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #ff9800;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #ff9800;
}
.mt-label.mt-label--warning:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #ff9800;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged) {
  background-color: #f9fafb;
  border-color: #f0f2f5;
  color: #52667a;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #d1d9e0;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #52667a;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #52667a;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #d1d9e0;
}
.mt-label.mt-label--neutral:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #d1d9e0;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged) {
  background-color: #189eff;
  border-color: #bae2ff;
  color: #e3f3ff;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged).mt-label--small::before {
  background: #189eff;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged) .mt-label__dismiss {
  color: #e3f3ff;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged) .mt-label__dismiss .mt-icon {
  color: #e3f3ff;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged).mt-label--ghost {
  background: transparent;
  border-color: #189eff;
}
.mt-label.mt-label--primary:not(.mt-label--appearance-badged).mt-label--dismissable:hover {
  border-color: #189eff;
}/* ------------------------------------
 * Administration variables
 * Table of contents
...
.mt-highlight-text .mt-highlight-text__highlight {
  color: #189eff;
  font-weight: bold;
}/* ------------------------------------
 * Administration variables
...
&[data-v-8acbd283]:focus-visible:not(.mt-textarea__textarea--error) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0px 0px 4px 0px rgba(24, 158, 255, 0.3);
}
&[data-v-8acbd283]::placeholder {
    color: var(--color-text-secondary-default);
}
&[data-v-8acbd283]:disabled {
    color: var(--color-text-primary-disabled);
    background-color: var(--color-background-primary-disabled);
    cursor: not-allowed;
}
}
.mt-textarea__textarea--error[data-v-8acbd283] {
  border-color: var(--color-border-critical-default);
  background-color: var(--color-background-critical-dark);
}
.mt-textarea__hint[data-v-8acbd283] {
  grid-area: hint;
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
...
.mt-textarea__max-length[data-v-8acbd283] {
...
.mt-popover-item__label, .mt-popover-item__contextual-detail, .mt-popover-item__shortcut {
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  font-weight: var(--font-weight-medium);
}
.mt-popover-item__label--clickable, .mt-popover-item__contextual-detail--clickable, .mt-popover-item__shortcut--clickable {
  cursor: pointer;
}
...
.mt-popover-item__visibility, .mt-popover-item__options {
  cursor: pointer;
...
&:not(:has(.mt-card__tabs:empty)) .mt-card__header[data-v-906d0ef8] {
    border-bottom: none;
}
}
.mt-card--future-remove-default-margin[data-v-906d0ef8] {
  margin-block-end: 0;
}
.mt-card__content {
&[data-v-906d0ef8] {
...
&[data-v-906d0ef8] > :where(h1, h2, h3, h4, h5, h6) {
    font-weight: normal;
}
& > h1[data-v-906d0ef8] {
    font-size: 1.5rem;
...
&[data-v-906d0ef8] > :where(h4, h5, h6) {
    font-size: 1.125rem;
}
...
&[data-v-906d0ef8]:hover {
      color: var(--color-text-brand-hover);
}
}
}
.mt-card--has-footer {
& .mt-card__content[data-v-906d0ef8] {
    border: none;
...
& .mt-card__title[data-v-906d0ef8],
  & .mt-card__subtitle[data-v-906d0ef8] {
    width: auto;
    position: relative;
    top: 0;
    left: 0;
...
.mt-card--future-ignore-max-width[data-v-906d0ef8] {
  max-width: none;
  margin-inline: 0;
}
.mt-card__titles[data-v-906d0ef8] {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
}
...
& .mt-card__inheritance-toggle[data-v-906d0ef8] {
    color: var(--color-icon-accent-default);
}
}
.mt-card--grid {
...
& .mt-grid[data-v-906d0ef8] {
      border-top: none;
}
}
}
.mt-card__header[data-v-906d0ef8] {
  display: flex;
  flex-wrap: wrap;
  align-items: stretch;
...
&[data-v-906d0ef8]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-button);
}
}
.mt-card__titles-right-slot[data-v-906d0ef8] {
  color: var(--color-text-primary-default);
  margin-left: auto;
}
.mt-card__footer {
...
.mt-empty-state[data-v-9b29fb26] {
  display: flex;
  flex-direction: column;
  align-items: flex-start;
}
.mt-empty-state__icon[data-v-9b29fb26] {
  display: inline-block;
  padding: var(--scale-size-12);
  border-radius: var(--border-radius-xs);
  background-color: var(--color-interaction-secondary-dark);
}
.mt-empty-state__headline[data-v-9b29fb26] {
  margin-top: var(--scale-size-24);
  margin-bottom: 0;
}
.mt-empty-state__description[data-v-9b29fb26] {
  margin-top: var(--scale-size-8);
}
.mt-empty-state__link[data-v-9b29fb26] {
  margin-top: var(--scale-size-8);
}
.mt-empty-state__button[data-v-9b29fb26] {
  margin-top: var(--scale-size-24);
}

.mt-tabs[data-v-989fd449] {
  display: flex;
  position: relative;
  box-shadow: inset 0 -1px 0 var(--color-border-primary-default);
}
.mt-tabs--small[data-v-989fd449] {
  max-width: 800px;
  margin: 0 auto 15px auto;
}
.mt-tabs--future-remove-default-margin[data-v-989fd449] {
  margin-block-end: 0;
}
.mt-tabs--vertical {
&[data-v-989fd449] {
...
& .mt-tabs__slider[data-v-989fd449] {
    top: 0;
    bottom: auto;
    left: 3px;
}
...
&[data-v-989fd449]:disabled {
    cursor: not-allowed;
    color: var(--color-text-primary-disabled);
}
&[data-v-989fd449]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-xs);
}
&[data-v-989fd449]::after {
...
.mt-tabs__item--error[data-v-989fd449] {
  color: var(--color-text-critical-default);
}
.mt-tabs__item--active[data-v-989fd449] {
  font-weight: var(--font-weight-medium);
}
.mt-tabs__slider[data-v-989fd449] {
...
.mt-tabs__slider--error[data-v-989fd449] {
  background-color: var(--color-border-critical-default);
}
.mt-tabs__slider--animated[data-v-989fd449] {
...
.mt-tabs__error-badge[data-v-989fd449] {
...
&[data-v-15f31fb9] :last-child {
    border-top-right-radius: var(--border-radius-xs);
    border-bottom-right-radius: var(--border-radius-xs);
}
&[data-v-15f31fb9] :first-child {
    border-top-left-radius: var(--border-radius-xs);
    border-bottom-left-radius: var(--border-radius-xs);
}
}
.mt-pagination__controls[data-v-15f31fb9] {
  display: inline-flex;
  border-radius: var(--border-radius-xs);
  border: 1px solid var(--color-border-primary-default);
}
.mt-pagination__info-text[data-v-15f31fb9] {
  color: var(--color-text-tertiary-default);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  font-family: var(--font-family-body);
...
&[data-v-15f31fb9]:focus-visible {
    outline: 1px solid var(--color-border-brand-selected);
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-15f31fb9]:hover:not(:disabled) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-15f31fb9]:last-of-type {
    border-right: none;
}
&[data-v-15f31fb9]:disabled {
...
&[data-v-15f31fb9]::-webkit-outer-spin-button,
  &[data-v-15f31fb9]::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
}
&[type="number"][data-v-15f31fb9] {
    -moz-appearance: textfield;
}
}
...
&[data-v-42e93114]:focus-within {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
}
.mt-search--size-default[data-v-42e93114] {
  padding: var(--scale-size-12) var(--scale-size-16);
}
.mt-search--size-small[data-v-42e93114] {
  padding: var(--scale-size-4) var(--scale-size-16);
}
.mt-search__input {
&[data-v-42e93114] {
...
&[data-v-42e93114]::-webkit-search-cancel-button,
  &[data-v-42e93114]::-webkit-search-decoration,
  &[data-v-42e93114]::-webkit-search-results-button,
  &[data-v-42e93114]::-webkit-search-results-decoration {
    display: none;
}
&[data-v-42e93114]::placeholder {
    color: var(--color-text-secondary-default);
}
&:disabled {
&[data-v-42e93114] {
...
.mt-search--disabled[data-v-42e93114] {
  background-color: var(--color-background-primary-disabled);
}
/* ------------------------------------
 * Administration variables
...
&[data-v-cc2292f7]:not(:last-child) {
    margin-bottom: var(--scale-size-32);
}
}
.mt-skeleton-bar__shimmer[data-v-cc2292f7] {
  height: 100%;
  ...
  animation: barShimmer-cc2292f7 1.8s infinite;
  animation-timing-function: linear;
  transform: translate(-100%);
}
@keyframes barShimmer-cc2292f7 {
to {
 ...
 * 8. z-index
 * ------------------------------------ */
@keyframes ellipsis-8ed67238 {
to {
    width: 1.25rem;
}
}
.mt-data-table-text-renderer-cell[data-v-8ed67238] {
  display: flex;
  align-items: center;
}
.mt-data-table-text-renderer-cell .mt-data-table-preview-image-renderer[data-v-8ed67238] {
  position: relative;
  width: 34px;
  height: var(--scale-size-24);
  border: 1px solid var(--color-border-primary-default);
...
.mt-data-table-text-renderer-cell .mt-data-table-preview-image-renderer img.mt-data-table-preview-image-renderer-item[data-v-8ed67238] {
  position: absolute;
  left: 50%;
  top: 50%;
  transform: translate(-50%, -50%);
...
.mt-data-table-text-renderer-cell a.mt-data-table-text-renderer[data-v-8ed67238] {
  font-weight: var(--font-weight-medium);
  text-decoration: none;
  color: var(--color-text-primary-default);
}
.mt-data-table-text-renderer-cell a.mt-data-table-text-renderer[data-v-8ed67238]:hover {
  text-decoration: underline;
  color: var(--color-text-brand-default);
}
...
.mt-segmented-control__action {
  ...
  font-weight: var(--font-weight-semibold);
  color: var(--color-text-primary-default);
  transition: 0.15s background ease, 0.15s color ease;
  justify-content: center;
  text-align: center;
}
...
.mt-segmented-control__action:hover, .mt-segmented-control__action:focus-visible {
  background-color: var(--color-interaction-secondary-hover);
}
...
.mt-segmented-control__action--pressed:not(.mt-segmented-control__action--critical):hover, .mt-segmented-control__action--pressed:not(.mt-segmented-control__action--critical):focus-visible {
...
.mt-segmented-control__action--critical.mt-segmented-control__action--pressed:hover, .mt-segmented-control__action--critical.mt-segmented-control__action--pressed:focus-visible {
...
.mt-segmented-control__action--critical:hover, .mt-segmented-control__action--critical:focus-visible {
  background-color: var(--color-background-critical-dark);
}
...
&[data-v-42e67b6c]:hover,
  &[data-v-42e67b6c]:focus-visible {
    color: var(--color-text-brand-hover);
    text-decoration: none;
}
}
...
.mt-data-table-filter__property[data-v-8b7c4be6] {
  border: 1px solid var(--color-border-primary-default);
  border-right: 0 none;
  border-top-left-radius: var(--border-radius-xs);
  border-bottom-left-radius: var(--border-radius-xs);
...
.mt-data-table-filter__rule[data-v-8b7c4be6] {
  border-top: 1px solid var(--color-border-primary-default);
  border-bottom: 1px solid var(--color-border-primary-default);
  padding-right: var(--scale-size-4);
}
...
& button[data-v-8b7c4be6] {
    outline: 0 none;
}
&[data-v-8b7c4be6]:has(button:hover) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-8b7c4be6]:has(button:focus-visible) {
    background-color: var(--color-background-brand-default);
...
& .mt-icon[data-v-8b7c4be6] {
    position: absolute;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
}
&[data-v-8b7c4be6]:focus-visible {
    background-color: var(--color-background-brand-default);
    border-color: var(--color-border-brand-selected);
}
&[data-v-8b7c4be6]:hover {
    background-color: var(--color-interaction-secondary-hover);
}
}

.mt-inset[data-v-2baaeb42] {
  margin-block-start: calc(var(--mt-inset-block-start, --mt-inset-top) * -1);
  margin-inline-end: calc(var(--mt-inset-inline-end, --mt-inset-right) * -1);
  margin-block-end: calc(var(--mt-inset-block-end, --mt-inset-bottom) * -1);
  margin-inline-start: calc(var(--mt-inset-inline-start, --mt-inset-left) * -1);
}
/* ------------------------------------
 * Administration variables
 * Table of contents
...
&:hover {
.mt-toast-notification__timer-loader[data-v-b206e73c] {
      animation-play-state: paused;
}
}
&[data-v-b206e73c]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
...
&.mt-icon > svg[data-v-b206e73c] {
    fill: black;
    width: var(--scale-size-20) !important;
    height: var(--scale-size-20) !important;
}
}
.mt-toast-notification__content-left[data-v-b206e73c] {
  display: flex;
  flex: 1;
...
.mt-toast-notification__content-right[data-v-b206e73c] {
  display: flex;
  justify-content: flex-end;
  margin-right: var(--scale-size-16);
  align-items: center;
}
.mt-toast-notification__timer[data-v-b206e73c] {
  height: 3px;
  width: 100%;
...
.mt-toast-notification__timer-loader[data-v-b206e73c] {
  ...
  animation: shrink-b206e73c 10s forwards linear 0.5s;
}
@keyframes shrink-b206e73c {
from {
    transform: scaleX(1);
}
to {
...
.mt-toast-notification__message[data-v-b206e73c] {
  max-width: 200px;
  text-overflow: ellipsis;
  overflow: hidden;
  white-space: nowrap;
}
.mt-toast-notification__message-space[data-v-b206e73c] {
  padding-left: var(--scale-size-8);
}
.mt-toast-notification__content {
&[data-v-b206e73c] {
...
& .mt-toast-notification__close-action[data-v-b206e73c] {
 ...
 * 8. z-index
 * ------------------------------------ */
@keyframes ellipsis-5ff70956 {
to {
    width: 1.25rem;
}
}
.mt-toast[data-v-5ff70956] {
  display: flex;
  position: fixed;
  justify-content: center;
  bottom: 0;
...
.mt-toast--bottom-left[data-v-5ff70956] {
  flex: 1;
}
.mt-toast--bottom-center[data-v-5ff70956] {
  flex: 1;
  display: flex;
  justify-content: center;
}
.mt-toast--bottom-center .mt-toast-notification[data-v-5ff70956] {
  display: flex;
  z-index: 1600;
  position: absolute;
  height: 51px;
...
.mt-toast--bottom-center .quick-toasts-enter-active[data-v-5ff70956],
.mt-toast--bottom-center .quick-toasts-leave-active[data-v-5ff70956] {
  transition: opacity 0.5s ease;
}
.mt-toast--bottom-center .quick-toasts-enter-from[data-v-5ff70956],
.mt-toast--bottom-center .quick-toasts-leave-to[data-v-5ff70956] {
  opacity: 0;
}
.mt-toast--bottom-center .quick-toasts-enter-active[data-v-5ff70956] {
  transition-delay: 0.5s;
}
.mt-toast--bottom-right[data-v-5ff70956] {
  flex: 1;
  display: flex;
  justify-content: flex-end;
  padding-right: var(--scale-size-16);
}
.mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956] {
  display: flex;
...
.mt-toast--bottom-right .toasts-enter-from[data-v-5ff70956] {
  transform: translateY(50px) !important;
  opacity: 0;
  z-index: 0;
}
.mt-toast--bottom-right .toasts-leave-to[data-v-5ff70956] {
  transform: scale(0.9, 0.4) !important;
  transform-origin: top;
  opacity: 0;
  z-index: 0;
}
.mt-toast--bottom-right .toasts-enter-active[data-v-5ff70956],
.mt-toast--bottom-right .toasts-leave-active[data-v-5ff70956] {
  transition: all 0.7s ease;
}
.mt-toast--expanded .mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956]:nth-child(n+2) {
  transform: translateY(calc(var(--num) * -68px));
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956]:nth-child(1) {
  z-index: 1599;
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956]:nth-child(2) {
  transform: translateY(-33px) scale(0.95, 0.18);
  border-top-left-radius: 4.2105263158px 22.2222222222px;
  border-top-right-radius: 4.2105263158px 22.2222222222px;
  border-bottom-left-radius: 2.1052631579px 11.1111111111px;
  border-bottom-right-radius: 2.1052631579px 11.1111111111px;
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956]:nth-child(3) {
  transform: translateY(-45px) scale(0.9, 0.18);
  border-top-left-radius: 4.4444444444px 22.2222222222px;
  border-top-right-radius: 4.4444444444px 22.2222222222px;
  border-bottom-left-radius: 2.2222222222px 11.1111111111px;
  border-bottom-right-radius: 2.2222222222px 11.1111111111px;
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-5ff70956]:nth-child(n+4) {
...
.mt-modal--width-s[data-v-f9441d24] {
  --mt-modal-width: 27.5rem;
}
.mt-modal--width-m[data-v-f9441d24] {
  --mt-modal-width: 45rem;
}
.mt-modal--width-l[data-v-f9441d24] {
  --mt-modal-width: 64rem;
}
.mt-modal--width-xl[data-v-f9441d24] {
  --mt-modal-width: 90rem;
}
.mt-modal--width-full[data-v-f9441d24] {
  --mt-modal-width: 100%;
}
.modal-enter-active[data-v-f9441d24] {
...
.modal-leave-active[data-v-f9441d24] {
...
.modal-enter-from[data-v-f9441d24],
.modal-leave-to[data-v-f9441d24] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__title[data-v-f9441d24] {
  margin-block-end: 0;
}
.mt-modal__content[data-v-f9441d24] {
  position: relative;
  overflow-y: auto;
}
.mt-modal__content-inner[data-v-f9441d24] {
  padding: var(--scale-size-24);
}
.mt-modal__content-inner--no-padding[data-v-f9441d24] {
  padding: 0;
}
.mt-modal__scroll-shadow[data-v-f9441d24] {
  position: sticky;
  left: 0;
  right: 0;
  height: var(--scale-size-4);
...
.mt-modal__scroll-shadow--top[data-v-f9441d24] {
  top: 0;
}
.mt-modal__scroll-shadow--bottom[data-v-f9441d24] {
  bottom: 0;
}
.shadow-fade-enter-active[data-v-f9441d24] {
  transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
}
}
.shadow-fade-leave-active[data-v-f9441d24] {
  transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
}
}
.shadow-fade-enter-from[data-v-f9441d24],
.shadow-fade-leave-to[data-v-f9441d24] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__footer[data-v-f9441d24] {
  padding: var(--scale-size-24);
  border-top: 1px solid var(--color-border-primary-default);
}
.mt-modal__header[data-v-f9441d24] {
  padding: var(--scale-size-24);
  border-bottom: 1px solid var(--color-border-primary-default);
  display: flex;
  justify-content: space-between;
...
.mt-modal__header-content[data-v-f9441d24] {
  display: flex;
  flex-direction: row;
  align-items: baseline;
  column-gap: var(--scale-size-8);
...
@media (hover: hover) {
&[data-v-f9441d24]:hover {
      background-color: var(--color-interaction-secondary-hover);
}
}
&[data-v-f9441d24]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
}

.mt-modal-root__backdrop[data-v-9f7d61dc] {
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
.fade-enter-active[data-v-9f7d61dc] {
  transition: opacity 150ms cubic-bezier(0.3, 0, 1, 1);
}
.fade-leave-active[data-v-9f7d61dc] {
  transition: opacity 150ms cubic-bezier(0, 0, 0, 1);
}
.fade-enter-from[data-v-9f7d61dc],
.fade-leave-to[data-v-9f7d61dc] {
  opacity: 0;
}
...
.mt-icon[data-v-15afc97f] {
    transition: 0.1s all ease-in-out;
    color: var(--color-text-secondary-default);
}
&:hover .mt-icon[data-v-15afc97f] {
    color: var(--color-interaction-primary-hover);
}
&.is-active .mt-icon[data-v-15afc97f] {
    color: var(--color-interaction-primary-pressed);
}
&[data-v-15afc97f]:disabled {
    cursor: not-allowed;
}
}
.mt-text-editor-toolbar-button:disabled .mt-icon[data-v-15afc97f] {
  color: var(--color-text-secondary-disabled);
}

.mt-text-editor-toolbar[data-v-4dd9bed0] {
...
.mt-text-editor-toolbar__buttons-left[data-v-4dd9bed0],
.mt-text-editor-toolbar__buttons-right[data-v-4dd9bed0] {
  display: flex;
  align-items: center;
  height: 100%;
}
...
.mt-text-editor-toolbar[data-v-4dd9bed0] .mt-floating-ui {
  height: inherit;
}
.mt-text-editor-toolbar[data-v-4dd9bed0] .mt-floating-ui__trigger {
  display: block;
  height: inherit;
}
.mt-text-editor--inline-edit .mt-text-editor-toolbar[data-v-4dd9bed0] {
  border: none;
  border-radius: var(--border-radius-xs);
  box-shadow:
    0 1px 1px rgba(0, 0, 0, 8%),
...
[data-v-f06f87c1] .mt-colorpicker__previewWrapper {
    width: var(--scale-size-14);
    height: var(--scale-size-14);
}
[data-v-f06f87c1] .mt-colorpicker--compact .mt-colorpicker__colorpicker-position {
    left: calc(-1 * (14px + 24px) / 2);
    top: calc(100% + var(--scale-size-14) + 4px);
}
}

.mt-text-editor__link-modal-footer[data-v-f68a01fa] {
  display: flex;
  justify-content: flex-end;
  gap: var(--scale-size-8);
}

.mt-text-editor__table-modal-footer[data-v-33d27363] {
  display: flex;
  justify-content: flex-end;
  gap: var(--scale-size-8);
}

.mt-text-editor[data-v-f477361b] {
  display: flex;
  flex-direction: column;
  background-color: var(--color-elevation-surface-default);
}
label[data-v-f477361b] {
  display: block;
  font-size: var(--font-size-xs);
  line-height: 1rem;
  color: var(--color-text-primary-default);
...
.mt-text-editor__box[data-v-f477361b] {
  border: 1px solid var(--color-border-primary-default);
  border-radius: var(--border-radius-xs);
}
.mt-text-editor__content[data-v-f477361b],
.mt-text-editor__code-editor[data-v-f477361b] {
  height: 260px;
  overflow: auto;
}
.mt-text-editor__code-editor[data-v-f477361b] .cm-editor {
  height: inherit;
}
[data-v-f477361b] .mt-text-editor__content-editor {
  width: 100%;
  height: 100%;
  padding: var(--scale-size-16);
...
.mt-text-editor__footer[data-v-f477361b] {
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 0 var(--scale-size-16);
...
.mt-text-editor__footer-left[data-v-f477361b] {
  display: flex;
  align-items: center;
}
...
.mt-text-editor--inline-edit:focus-within .mt-text-editor__footer[data-v-f477361b] {
  pointer-events: all;
  transform: scale(1, 1);
}
.mt-text-editor--disabled .mt-text-editor__content[data-v-f477361b] {
  background-color: var(--color-background-primary-disabled);
}
[data-v-f477361b] .mt-text-editor__content-editor p.is-editor-empty:first-child::before {
  color: var(--color-text-secondary-default);
...
.mt-text-editor--error .mt-text-editor__box[data-v-f477361b] {
  border-color: var(--color-icon-critical-default);
}
.mt-text-editor--error .mt-text-editor__content[data-v-f477361b] {
  background-color: var(--color-background-critical-dark);
}
.mt-text-editor--error label[data-v-f477361b] {
  color: var(--color-text-critical-default);
}

.mt-url-field[data-v-72286d19] {
  display: grid;
  grid-template-columns: 1fr auto;
  grid-template-areas:
    "label help-text"
...
.mt-url-field--future-remove-default-margin[data-v-72286d19] {
  margin-bottom: 0;
}
.mt-url-field__block {
&[data-v-72286d19] {
...
&[data-v-72286d19]:has(.mt-url-field__input:focus-visible) {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
&[data-v-72286d19]:has(.mt-url-field__input:disabled) {
    background: var(--color-background-primary-disabled);
}
}
.mt-url-field__block--size-default[data-v-72286d19] {
  min-height: var(--scale-size-48);
}
.mt-url-field__block--size-small[data-v-72286d19] {
  min-height: var(--scale-size-32);
}
.mt-url-field__block--error[data-v-72286d19] {
  border-color: var(--color-border-critical-default);
  background: var(--color-background-critical-dark);
}
.mt-url-field__input {
...
&[data-v-72286d19]::placeholder {
    color: var(--color-text-secondary-default);
}
}
.mt-url-field__affix[data-v-72286d19] {
  display: grid;
  place-items: center;
  height: 100%;
  background: var(--color-interaction-secondary-default);
...
.mt-url-field__affix--disabled[data-v-72286d19] {
  background: var(--color-interaction-secondary-disabled);
}
.mt-url-field__affix--prefix[data-v-72286d19] {
  border-top-left-radius: var(--border-radius-xs);
  border-bottom-left-radius: var(--border-radius-xs);
  border-right: 1px solid var(--color-border-primary-default);
  font-size: var(--font-size-xs);
...
.mt-url-field__affix--suffix[data-v-72286d19] {
  border-top-right-radius: var(--border-radius-xs);
  border-bottom-right-radius: var(--border-radius-xs);
  border-left: 1px solid var(--color-border-primary-default);
  font-size: var(--font-size-2xs);
...
&[data-v-72286d19]:focus-visible {
    outline-offset: 4px;
    outline: 2px solid var(--color-border-brand-selected);
    border-radius: var(--border-radius-xs);
}
&[data-v-72286d19]:disabled {
    cursor: default;
}
}
...
&[data-v-72286d19]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-72286d19]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
...
.mt-url-field__hint[data-v-72286d19] {
  grid-area: hint;
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
...
@supports (font-variation-settings: normal) {
  body {
    font-family: "Inter var", -apple-system, BlinkMacSystemFont, "San Francisco", "Segoe UI", Roboto, "Helvetica Neue", sans-serif;
    font-feature-settings: "cv10" on, "cv05" on, "cv02" on, "cv07" on, "cv09" on, "cv04" on, "cv03" on;
  }
}
.mt-drag-select-box {
  position: absolute;
...
a[target=_blank]:not(.mt-internal-link, .mt-button)::after {
  content: "";
  display: inline-block;
  width: 0.715em;
  height: 0.715em;
