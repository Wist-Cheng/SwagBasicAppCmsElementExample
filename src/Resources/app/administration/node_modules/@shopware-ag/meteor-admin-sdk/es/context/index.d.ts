...
export declare const compareShopwareVersion: (messageOptions: Omit<import("../channel").MessageDataType<"contextCompareShopwareVersion">, never> & import("../channel").BaseMessageOptions) => Promise<boolean>;
